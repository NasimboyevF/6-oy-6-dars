...
const Card = () => {
    ...
    return (
        ...
        <div className='flex w-[1240px] mx-auto justify-between gap-4'>
            <div className=" w-full  bg-[#5facff]  h-[360px] rounded-[10px] mt-[40px] ">
            ...
            <div className=" w-full  bg-[#3563E9;]  h-[360px] rounded-[10px] mt-[40px] ">
                <div className="ml-[24px] py-[24px]">
                    <div>
